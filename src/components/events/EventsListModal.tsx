...
import { UserEvent, UserEventTypes } from '../../types-luach-web';
import { getAnniversaryNumber } from '../../lib/userEventUtils';
...
}> = ({ field, label, currentSortField, currentSortDirection, onSort }) => (
  <button
    ...
    style={{
      fontSize: '1em',
      padding: '0.5em',
      color: currentSortField === field ? 'var(--accent-amber)' : 'var(--text-secondary)',
    }}
  >
    {label}
