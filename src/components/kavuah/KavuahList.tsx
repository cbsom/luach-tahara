...
export const KavuahList: React.FC<KavuahListProps> = ({ isOpen, onClose, lang }) => {
  const { kavuahs, loading, removeKavuah, toggleActive } = useKavuahs(false);
            ...
            {kavuahs.map((kavuah: KavuahRecord) => (
              ...
              >
                <div className="flex flex-col">
                  <span className="font-bold text-lg">{getKavuahTypeName(kavuah.kavuahType)}</span>
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    title={kavuah.active ? t('Deactivate', 'הפוך ללא פעיל') : t('Activate', 'הפעל')}
                  >
